export function renderCountryReports(reports) {
  if (!reports?.length) {
    return `
      <section class="ch-section" id="ch-reports" data-reveal-section>
        <div class="ch-section__head"><h2>Country Reports</h2></div>
        <p class="ch-empty">No reports available for this country.</p>
      </section>`;
  }
  ...
  return `
    <section class="ch-section" id="ch-reports">
      <div class="ch-section__head">
        <h2>Country Reports</h2>
        <p class="ch-section__desc">Ministry reports and publications</p>
      </div>
